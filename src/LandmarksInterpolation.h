...
public:
    void interpolate( std::vector<ft::FaceFeature *> &lms, const QList<QList<int>> &indices_list);
...
private:
    ...
    void interpolateGroup( std::vector<ft::FaceFeature *> &lms_grp, const QList<QList<int>> &list);
